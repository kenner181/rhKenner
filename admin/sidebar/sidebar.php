...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <a href="../admin/tabla_usuarios.php" class="nav_link">
            <i class='bx bx-user nav_icon'></i>
            <span class="nav_name"> REGISTROS DE USUARIOS</span> </a>

        <a href="../admin/tabla_tipo_usu.php" class="nav_link">
            <i class='bx bx-user nav_icon'></i>
            <span class="nav_name">TIPOS DE USUARIOS</span> </a>

        <a href="../admin/tabla_permisos.php" class="nav_link">
            <i class='bx bx-user nav_icon'></i>
            <span class="nav_name">PERMISOS</span> </a>

        <a href="../admin/tabla_prestamos.php" class="nav_link">
            <i class='bx bx-user nav_icon'></i>
            <span class="nav_name">SOLIT. DE PRESTAMO</span> </a>

        <a href="../admin/tabla_cargo.php" class="nav_link">
            <i class='bx bx-user nav_icon'></i>
            <span class="nav_name">TIPOS DE CARGO</span> </a>

        <a href="../admin/tabla_per.php" class="nav_link">
            <i class='bx bx-user nav_icon'></i>
            <span class="nav_name">TRAM. PERMISO</span> </a>

        <a href="../admin/tabla_aux.php" class="nav_link">
            <i class='bx bx-user nav_icon'></i>
            <span class="nav_name">AUX. TRANSPORTE</span> </a>

        <a href="../admin/tabla_arl.php" class="nav_link">
            <i class='bx bx-user nav_icon'></i>
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">A.K.A </span> </a>
                ...
                <form class="nav_name" action="cerrar_sesion.php" method="post">
